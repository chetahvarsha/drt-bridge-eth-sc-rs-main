...
pub trait StorageModule {
    ...
    #[view(getDcdtSafeAddress)]
    #[storage_mapper("dcdtSafeAddress")]
    fn dcdt_safe_address(&self) -> SingleValueMapper<ManagedAddress>;

    #[view(getMultiTransferDcdtAddress)]
    #[storage_mapper("multiTransferDcdtAddress")]
    fn multi_transfer_dcdt_address(&self) -> SingleValueMapper<ManagedAddress>;

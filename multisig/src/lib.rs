...
pub mod multi_transfer_dcdt_proxy;
    ...
    + dharitri_sc_modules::pause::PauseModule
{
    ...
    fn init(
        &self,
        dcdt_safe_sc_address: ManagedAddress,
        ...
        require!(
            self.blockchain().is_smart_contract(&dcdt_safe_sc_address),
            "Dcdt Safe address is not a Smart Contract address"
        );
        self.dcdt_safe_address().set(&dcdt_safe_sc_address);
        ...
        self.multi_transfer_dcdt_address()
    ...
    fn propose_dcdt_safe_set_current_transaction_batch_status(
        ...
        require!(
            self.action_id_for_set_current_transaction_batch_status(dcdt_safe_batch_id)
                .get(&statuses_vec)
                .is_none(),
        ...
        require!(
            dcdt_safe_batch_id == current_batch_id,
            "Current DcdtSafe tx batch does not have the provided ID"
        );
    ...
    fn propose_multi_transfer_dcdt_batch(
        ...
        let action_id = self.propose_action(Action::BatchTransferDcdtToken {
            eth_batch_id,
    ...
    fn withdraw_slashed_amount(&self) {
        ...
        self.tx().to(ToCaller).rewa(&slashed_amount).transfer();
        ...
        match action {
            ...
            Action::BatchTransferDcdtToken {
                ...
                self.tx()
                    .to(multi_transfer_dcdt_addr)
                    .typed(multi_transfer_dcdt_proxy::MultiTransferDcdtProxy)
                    .batch_transfer_dcdt_token(eth_batch_id, transfers_multi)
                    .sync_call();
            }
        }
    }

...
pub struct MultiTransferDcdtProxy;

impl<Env, From, To, Gas> TxProxyTrait<Env, From, To, Gas> for MultiTransferDcdtProxy
where
    Env: TxEnv,
    From: TxFrom<Env>,
    To: TxTo<Env>,
    Gas: TxGas<Env>,
{
    type TxProxyMethods = MultiTransferDcdtProxyMethods<Env, From, To, Gas>;

    fn proxy_methods(self, tx: Tx<Env, From, To, (), Gas, (), ()>) -> Self::TxProxyMethods {
        MultiTransferDcdtProxyMethods { wrapped_tx: tx }
    }
}

pub struct MultiTransferDcdtProxyMethods<Env, From, To, Gas>
where
    Env: TxEnv,
    From: TxFrom<Env>,
    To: TxTo<Env>,
...
#[rustfmt::skip]
impl<Env, From, Gas> MultiTransferDcdtProxyMethods<Env, From, (), Gas>
where
    Env: TxEnv,
    Env::Api: VMApi,
    From: TxFrom<Env>,
...
#[rustfmt::skip]
impl<Env, From, To, Gas> MultiTransferDcdtProxyMethods<Env, From, To, Gas>
where
    Env: TxEnv,
    Env::Api: VMApi,
    From: TxFrom<Env>,
...
where
    ...
    Gas: TxGas<Env>,
{
    pub fn batch_transfer_dcdt_token<
        Arg0: ProxyArg<u64>,
    ...
    >(
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("batchTransferDcdtToken")
            .argument(&batch_id)
            .argument(&transfers)
            .original_result()
    }
    ...
    pub fn set_dcdt_safe_contract_address<
        Arg0: ProxyArg<OptionalValue<ManagedAddress<Env::Api>>>,
    >(
        self,
        opt_new_address: Arg0,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("setDcdtSafeContractAddress")
            .argument(&opt_new_address)
            .original_result()
    }
    ...
    pub fn dcdt_safe_contract_address(
        self,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, ManagedAddress<Env::Api>> {
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("getDcdtSafeContractAddress")
            .original_result()
    }
